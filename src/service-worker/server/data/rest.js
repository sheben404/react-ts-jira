...
export const projectDB = new Rest("__project");
export const epicDB = new Rest("__epic");
export const taskDB = new Rest("__task");
export const kanbanDB = new Rest("__kanban");
export const userDB = new Rest("__user");
export const taskTypeDB = new Rest("__task__type");
export const tagDB = new Rest("__tag__");
